...
document.addEventListener("DOMContentLoaded", function () {
  ...
  buyNowBtn.addEventListener("click", function () {
      ...
      const userConfirmed = confirm("Do you want to proceed with the payment?");
      
      // If user clicks "OK", redirect to a payment page (replace with your actual URL)
      if (userConfirmed) {
          window.location.href = "payment.html"; // Replace with actual payment URL
      }
  });
});
